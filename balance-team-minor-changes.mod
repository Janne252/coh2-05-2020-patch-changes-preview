				...
				<d2p1:anyType i:type="Folder">
					<Children>
						<d2p1:anyType i:type="BurnAttributes">
							<RelativeName>balance-team-minor-changes.xml</RelativeName>
						</d2p1:anyType>
					</Children>
		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>balance-team-minor-changes</Description>
					<Hidden>false</Hidden>
					<Name>balance-team-minor-changes</Name>
				</d2p1:anyType>
			</Children>
			<IsExpanded>false</IsExpanded>
		</d2p1:anyType>
	</Children>
	<Guid>fe45de8f-91cf-4d4b-a305-bad683af400b</Guid>
	<IsExpanded>false</IsExpanded>
